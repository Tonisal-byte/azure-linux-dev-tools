...
const (
	...
	// OriginTypeCargoVendor indicates that the source file is a vendor tarball generated by cargo.
	OriginTypeCargoVendor OriginType = "cargo-vendor"

	// OriginTypeRust2RPM indicates that the source file is a spec generated by rust2rpm.
...
type Origin struct {
	...
	Type OriginType `toml:"type" json:"type" jsonschema:"required,enum=download,enum=cargo-vendor,enum=rust2rpm,title=Origin type,description=Type of origin for this source file"`
	...
	// CratesFile identifies the .crates file to use for cargo-vendor and rust2rpm origin types.
	// Relative to the sources directory. Ignored for other origin types.
	CratesFile string `toml:"crates-file,omitempty" json:"cratesFile,omitempty" jsonschema:"title=Crates file,description=Path to the .crates file relative to the sources directory (for cargo-vendor and rust2rpm origins)"`
}
